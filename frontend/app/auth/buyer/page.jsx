  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (typeof window !== 'undefined') {
        localStorage.setItem('ecocycle_role', 'buyer');
        localStorage.setItem('ecocycle_user', JSON.stringify({ email: form.email }));
      }
      router.push('/market');
    } catch (error) {
      ...
      <main className="min-h-[calc(100dvh-80px)] flex items-center justify-center px-4 pb-24 md:pb-0">
        <div className="w-full max-w-md">
          ...
          <div className="flex justify-center mb-8">
            <div className="inline-flex items-center gap-2 bg-secondary-container text-on-secondary-container px-4 py-2 rounded-full text-sm font-bold">
          ...
          <div className="bg-white rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.06)] border border-gray-100 p-8 md:p-10">
            <div className="mb-8">
              ...
              <p className="text-body-md text-on-surface-variant">
                Sign in to access the circular marketplace.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="flex items-center gap-3">
                ...
                />
                <label htmlFor="remember-buyer" className="text-sm text-secondary">

...
import { listenToMyListings, updateListing as dbUpdateListing, deleteListing as dbDeleteListing } from '@/services/index.js';
...
export default function MyListingsPage() {
  ...
  const handleSaveEdit = async (updated) => {
    try {
      await dbUpdateListing(updated.id, {
        name: updated.name || '',
  ...
  const handleConfirmDelete = async () => {
    try {
      await dbDeleteListing(delTarget.id);
      setDelTarget(null);
